  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                <Card key={num} className="relative overflow-hidden border-2 border-dashed border-primary/20 bg-card">
        ...
        {/* Popular Recipes — dữ liệu thật từ DB */}
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="mb-12 flex items-center justify-between">
              <div>
                <h2 className="mb-2 text-3xl font-bold text-foreground">Món Ăn Mới Nhất</h2>
                <p className="text-muted-foreground">Những công thức mới được thêm vào hệ thống.</p>
              </div>
              <Link href="/recipes">
        ...
        <section className="bg-primary py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="mb-4 text-3xl font-bold text-primary-foreground">Sẵn Sàng Nấu Ăn?</h2>
